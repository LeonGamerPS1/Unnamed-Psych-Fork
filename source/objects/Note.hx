...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?inEditor:Bool = false, ?createdFrom:Dynamic = null)
	{
		super();
	...
	@:isVar public var useAntialiasingFix(get, set):Bool = true;
