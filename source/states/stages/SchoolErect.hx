...
class SchoolErect extends BaseStage
{
	override function create()
	{
		...
		var bgSchool:BGSprite = new BGSprite('weeb/erect/weebSchool', repositionShit, 0, 0.9, 0.90);
		add(bgSchool);
		...
		{
			var fgTrees:BGSprite = new BGSprite('weeb/erect/weebBackTrees', repositionShit + 170, 190, 0.9, 0.9);
		...
		if (!ClientPrefs.data.lowQuality)
		{
			var treeLeaves:BGSprite = new BGSprite('weeb/erect/petals', repositionShit, -40, 0.9, 0.9, ['PETALS ALL'], true);
