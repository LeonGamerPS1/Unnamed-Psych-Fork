...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Miss on Sustain Release ',
			"If checked, the game counts it as a miss if you miss a sustain before it has been held entirely.", 'missOnRelease', 'bool');
		addOption(option);
